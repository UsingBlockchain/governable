 ...
 *
 */
export class Vote extends Executable {
  /**
   * @access public
   ...
   * descriptor for the `Vote` contract.
   *
   * @access public
   * @return {string}
   **/
  public get descriptor(): string {
    return 'Governable(v' + this.context.revision + ')' + ':vote:' + this.identifier.id
  }
